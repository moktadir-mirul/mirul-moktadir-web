      ...
      <div className="py-10 grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="">
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap items-center py-3 gap-3">
                ...
                <div>
                  <Link to={"https://github.com/moktadir-mirul/cuddly-paws-client"} target="_blank">
            ...
            <p className="font-bold text-lg text-justify py-1">
              ...
              → Secure Authentication & Role-Based Access <br />→ Fast,
        ...
        <div className="border border-primary rounded-lg p-5 relative flex flex-col gap-5">
          ...
          <div className="">
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap items-center py-3 gap-3">
                <div>
                  <Link to={"https://royal-bites-restaurant.web.app/"} target="_blank">
                  <button className="px-5 bg-gradient-to-r from-primary to-secondary cursor-pointer py-1  hover:bg-gradient-to-r hover:from-secondary hover:to-primary duration-200 transition-colors text-black font-bold text-xl shadow-md flex items-center gap-2 rounded-lg">
                    <CgMediaLive color="red"/> Live
                  </button></Link>
                </div>
                <div>
                  <Link to={"https://github.com/moktadir-mirul/royal-bites-client"} target="_blank">
                  <button className="px-5 bg-gradient-to-r from-primary to-secondary cursor-pointer py-1  hover:bg-gradient-to-r hover:from-secondary hover:to-primary duration-200 transition-colors text-black font-bold text-xl shadow-md flex items-center gap-2 rounded-lg"> <FaGithub /> Github</button></Link>
                </div>
                <div>
                  <Link to={"/royal-bites"}>
          ...
          <div className="">
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap items-center py-3 gap-3">
                ...
                <div>
                  <Link to={"https://github.com/moktadir-mirul/plant-companion-client"} target="_blank">
                  <button className="px-5 bg-gradient-to-r from-primary to-secondary cursor-pointer py-1  hover:bg-gradient-to-r hover:from-secondary hover:to-primary duration-200 transition-colors text-black font-bold text-xl shadow-md flex items-center gap-2 rounded-lg"> <FaGithub /> Github</button></Link>
                </div>
                <div>
            ...
            <p className="font-bold text-lg text-justify py-1">
              → Personalized Plant Care & Growth Tracking <br />
              → Smart Watering & Task Reminders <br />
              → Add & Organize Plant Profiles with Photos
            </p>
        ...
        <div className="border border-primary rounded-lg p-5 relative flex flex-col gap-5">
          ...
          <div className="">
            ...
            <p className="font-bold text-lg text-justify py-1">
              → Browse & View Detailed Job Listings Easily <br />
              → Firebase-Powered Authentication & User Profiles <br />
              → Responsive UI with Job Application Redirects
            </p>
